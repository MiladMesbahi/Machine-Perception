...
if __name__ == "__main__":
    ...
    if args.click_points:
        ...
        frame = imageio.imread("hw2_coding_part/data/frames/frame0000.jpg")
    ...
    frames = glob.glob('hw2_coding_part/data/frames/*.jpg')
    frames.sort()
    images = [np.array(imageio.imread(f)) for f in frames]

    # extrinsic 
    corners = np.load('hw2_coding_part/data/corners.npy')
    ...
    drill_mesh = trimesh.load("hw2_coding_part/data/models/drill.obj")
    fuze_mesh = trimesh.load("hw2_coding_part/data/models/fuze.obj")
