...
def main():
    ...
    penn = cv2.imread("C:/Users/milad/Downloads/hw1-coding-part/data/barcelona/images/logos/penn_engineering_logo.png")
    ...
    img_files = sorted(glob.glob("C:/Users/milad/Downloads/hw1-coding-part/data/barcelona/images/barca_real/*.png"))
    goal_data = np.load("C:/Users/milad/Downloads/hw1-coding-part/data/barcelona/BarcaReal_pts.npy")
